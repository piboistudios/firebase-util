...
@:jsRequire("@firebase/util") @valueModuleOnly extern class Util {
	/**
	...
	**/
	...
	/**
		...
		wait for a callback.
	**/
	static function isMobileCordova():Bool;
	/**
		Detect Node.js.
	**/
	...
	**/
	...
	static function isBrowserExtension():Bool;
	/**
		Detect React Native.
	**/
	static function isReactNative():Bool;
	/**
		Detects Electron apps.
	**/
	static function isElectron():Bool;
	/**
	...
	**/
	static function isUWP():Bool;
	/**
		Detect whether the current SDK build is the Node version.
	**/
	static function isNodeSdk():Bool;
	/**
	...
	**/
	static function isIndexedDBAvailable():Bool;
	/**
		This method validates browser/sw context for indexedDB by opening a dummy indexedDB database and reject
		if errors occur during the database open operation.
	**/
	static function validateIndexedDBOpenable():js.lib.Promise<Bool>;
	/**
		This method checks whether cookie is enabled within current browser
	**/
	static function areCookiesEnabled():Bool;
	/**
	...
	**/
	static function ordinal(i:Float):String;
